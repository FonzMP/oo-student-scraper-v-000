...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    student_hash = {:twitter => twitter if twitter, :linkedin => linkedin if linkedin, :github => github if github, :blog => blog if blog, :profile_quote => profile_quote if profile_quote, :bio => bio}
  end
